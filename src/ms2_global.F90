...
! define platform-specific path separator
  ...
  character(*), parameter :: IdNStepsMue                   = 'MUVTSteps'
  character(*), parameter :: IdNStepsMueL                  = 'MUVLSteps'
  character(*), parameter :: IdNStepsMueR                  = 'MUPRSteps'
  character(*), parameter :: IdNStepsMueP                  = 'MUPTSteps'
  ...
  character(*), parameter :: IdSite_NSites                 = 'NSites'
  ...
  character(*), parameter :: IdSite_mass                   = 'mass'
  character(*), parameter :: IdSite_shielding              = 'shielding'
  character(*), parameter :: IdSite_x                      = 'x'
  character(*), parameter :: IdSite_y                      = 'y'
  character(*), parameter :: IdSite_z                      = 'z'
  ...
  character(*), parameter :: IdTT_shielding                = 'shielding'
  character(*), parameter :: IdEATM_CATM                   = 'CATM'
  character(*), parameter :: IdEATM_A0                     = 'A0'
  character(*), parameter :: IdEATM_A2                     = 'A2'
  character(*), parameter :: IdEATM_A4                     = 'A4'  
  character(*), parameter :: IdEATM_A6                     = 'A6'
  character(*), parameter :: IdEATM_A8                     = 'A8'
  character(*), parameter :: IdEATM_alpha                  = 'alpha'
  character(*), parameter :: IdEATM_shielding              = 'shielding'
  character(*), parameter :: IdCharge_e                    = 'charge'
  character(*), parameter :: IdDipole_D                    = 'dipole'
  character(*), parameter :: IdQuadrupole_Q                = 'quadrupole'
  character(*), parameter :: IdTheta                       = 'theta'
  character(*), parameter :: IdPhi                         = 'phi'
