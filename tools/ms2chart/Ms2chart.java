    ...
    private void initComponents() {
        ...
        panelControlLayout.setHorizontalGroup(
            ...
            .add(panelControlLayout.createSequentialGroup()
                ...
                .add(comboXAxis, 0, 164, Short.MAX_VALUE)
                .addContainerGap())
            .add(panelControlLayout.createSequentialGroup()
                .add(12, 12, 12)
                .add(cbPROD)
            ...
            .add(panelControlLayout.createSequentialGroup()
                .addContainerGap()
                .add(jSeparator2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)
                .addContainerGap())
            .add(panelControlLayout.createSequentialGroup()
                .addContainerGap()
                .add(buttonQuit)
            ...
            .add(panelControlLayout.createSequentialGroup()
                .addContainerGap()
                .add(comboCaseList, 0, 218, Short.MAX_VALUE)
                .addContainerGap())
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, panelControlLayout.createSequentialGroup()
                        ...
                        .add(panelControlLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(panelControlLayout.createSequentialGroup()
                                .add(jLabel8)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(tfError, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE))
                            .add(panelControlLayout.createSequentialGroup()
                                .add(buttonDrawChart)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(cbAutoDraw)
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelChartContainer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 591, Short.MAX_VALUE))
