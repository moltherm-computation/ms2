...
{ % Tabellendefinitionen gelten nur in diesem Dokument
	...
	\begin{longtable}{Z B r}
		...
		a      &  probability that determines that the newly generated state is accepted or not &  \\
		...
		l     & length &  \\
		L & phenomenological coefficients which are related to the transport diffusion in a mixture &  \\
		M     & molar mass &  \\
		m     & mass  &  \\
		n  & solvation number around molecule i &  \\
		N_A   & Avogadro constant &  \\
		N  & number of  molecules  &  \\
		p     & pressure &  \\
		P  & probability of occurrence of the configurations &  \\
		q     & point charges magnitude &  \\
		Q     & quadrupole moment &  \\
		$\textit{R}$     & molar or universal gas constant &  \\
		r      & distance &  \\
		r_c   & cut-off radius Interactions &  \\
		S     & entropy &  \\
		T     & temperature &  \\
		t     & time  &  \\
		...
		V     & volume &  \\
		v     & velocity  &  \\
		w     & velocity of a sound wave traveling through an elastic medium &  \\
		$w $    & angular velocity &  \\
	...
	\begin{longtable}{Z B r}
		...
		\eta  & Lennard-Jones size-mixing parameter &  \\
		\eta  & shear viscosity &  \\
		...
		\xi   &  Lennard-Jones energy-mixing parameter &  \\
	...
	\begin{longtable}{Z l} 
		...
		% Symbolspalte wird immer in Matheumgebung gesetzt --> $ $ nicht nötig
		%************************************************************************
		*     & physical quantities in their reduced form \\
