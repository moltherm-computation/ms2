...
An ensembles is a set of all theoretically possible configurations under some specific macroscopic conditions. The canonical ensemble ($NVT$) is the set of all theoretically possible configurations under the same temperature $T$, volume $V$ and number of particles $N$, whereas the isobaric-isothermal ensemble ($NpT$) represents a system with constant temperature $T$, pressure $p$ and number of particles $N$.

representatives configuration that the MC markov chain procedure samples.
