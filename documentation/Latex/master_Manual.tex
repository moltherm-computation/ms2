...
\title{\textit{ms}2 -- user manual\footnotetext{Main author: Simon Stephan}  \\[5pt] }

\subtitle{A Molecular Simulation Tool for Thermodynamic Properties \\[40pt] \huge version 3.0}

\date{Kaiserslautern Paderborn, July 2017\footnote{The most up-tp-date version of the \textit{ms}2 manual is available for download at  \href{http://www.ms-2.de}{\textit{http://www.ms-2.de}.} }\\[400pt]}
